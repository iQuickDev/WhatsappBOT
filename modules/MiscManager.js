...
module.exports = class MiscManager {
    ...
    constructor() {
        ...
        this.commands = [this.help, this.uptime, this.igprofile, this.animeinfo, this.streamanime, this.fakeidentity, this.omegle, this.version]
        ...
        this.client.on('message_create', async (msg) => {
            await message.getChat().then(chat => {
                if (chat.id._serialized == group)
                    socket.emit('sendMessage', (msg.body))
            })
        })
    }
}
